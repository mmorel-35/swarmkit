...
func TestCreateService(t *testing.T) {
	...
	assert.ErrorContains(t, err, "name conflicts with an existing object")
}
...
func TestUpdateService(t *testing.T) {
	...
	require.ErrorIs(t, err, errModeChangeNotAllowed)
...
func TestServiceUpdateRejectNetworkChange(t *testing.T) {
	...
	require.ErrorIs(t, err, errNetworkUpdateNotSupported)
